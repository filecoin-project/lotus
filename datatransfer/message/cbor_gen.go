...
func (t *transferMessage) MarshalCBOR(w io.Writer) error {
	...
	// t.t.Request (message.transferRequest) (struct)
	if err := t.Request.MarshalCBOR(w); err != nil {
		return err
	}

	// t.t.Response (message.transferResponse) (struct)
