...
require (
	...
	github.com/filecoin-project/chain-validation v0.0.6-0.20200907020853-f4e4e7417fea
	...
	github.com/filecoin-project/go-fil-markets v0.5.10-0.20200907054005-9945d0d2141a
