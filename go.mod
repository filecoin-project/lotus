...
require (
	...
	github.com/xorcare/golden v0.8.4 // dependency-check-ignore: unknown
...
require (
	filippo.io/bigmod v0.1.1-0.20260103110540-f8a47775ebe5 // indirect; dependency-check-ignore: required by filippo.io/keygen
	filippo.io/keygen v0.0.0-20260114151900-8e2790ea4c5b // indirect; dependency-check-ignore: required by go-libp2p WebTransport deterministic ECDSA keygen
