...
type BlockHeader struct {
	...
	// CID of the root data structure representing the state of the *parent*
	// tipset: the VM state generated after applying the messages from the
	// blocks in `Parents` (not the messages from *this* block).
	// This is redundant information which is validated to match against the
	// state generated by our VM locally (see `ValidateBlock`). Once validated
	// it is accepted as a reliable representation of our cached version of the
	// state and referenced directly for performance reasons.
	ParentStateRoot cid.Cid // 8

	// Similar use as ParentStateRoot above but for the receipts of the
	// individual messages.
