...
func (mr *MessageReceipt) MarshalCBOR(w io.Writer) error {
	...
	case MessageReceiptV2:
		m = &messageReceiptV2{mr}
	default:
...
func (mr *MessageReceipt) UnmarshalCBOR(r io.Reader) (err error) {
	*mr = MessageReceipt{}
	...
	case 6:
		mr.version = MessageReceiptV2
		u = &messageReceiptV2{mr}
	default:
...
// messageReceiptV2: 6-element CBOR array [ExitCode, Return, GasUsed, EventsRoot, IpldCodec, Message]
// Introduced by FIP-0107.

var lengthBufCMessageReceiptV2 = []byte{134} // CBOR array of 6

func (t *messageReceiptV2) MarshalCBOR(w io.Writer) error {
	cw := cbg.NewCborWriter(w)

	if _, err := cw.Write(lengthBufCMessageReceiptV2); err != nil {
		return err
	}
	...
	if t.IpldCodec == nil {
		...
		if err := cw.WriteMajorTypeHeader(cbg.MajUnsignedInt, *t.IpldCodec); err != nil {
			return err
		}
	}
	...
	if t.Message == nil {
		...
		if err := cbg.WriteCid(cw, *t.Message); err != nil {
			return xerrors.Errorf("failed to write cid field t.Message: %w", err)
		}
	}
...
func (t *messageReceiptV2) UnmarshalCBOR(r io.Reader) (err error) {
	cr := cbg.NewCborReader(r)
	...
	// t.IpldCodec (*uint64)
	{
		...
		if b != cbg.CborNull[0] {
			...
			if maj != cbg.MajUnsignedInt {
				return fmt.Errorf("wrong type for uint64 field IpldCodec: %d", maj)
			}
			t.IpldCodec = &extra
		}
	}
	...
	// t.Message (*cid.Cid)
	{
		...
		if b != cbg.CborNull[0] {
			...
			c, err := cbg.ReadCid(cr)
			if err != nil {
				return xerrors.Errorf("failed to read cid field t.Message: %w", err)
			}
