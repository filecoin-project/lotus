...
func (t *MessageReceipt) MarshalCBOR(w io.Writer) error {
	...
	// t.Events (cid.Cid) (struct)

	if err := cbg.WriteCid(cw, t.Events); err != nil {
		return xerrors.Errorf("failed to write cid field t.Events: %w", err)
	}
...
func (t *MessageReceipt) UnmarshalCBOR(r io.Reader) (err error) {
	*t = MessageReceipt{}
...

	{
		...
		c, err := cbg.ReadCid(cr)
		if err != nil {
			return xerrors.Errorf("failed to read cid field t.Events: %w", err)
		}
