...
var lengthBufLegacyEvent = []byte{130}

func (t *LegacyEvent) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	...
	if _, err := cw.Write(lengthBufLegacyEvent); err != nil {
		return err
	}
	...
	// t.Entries ([]types.LegacyEventEntry) (slice)
	if len(t.Entries) > cbg.MaxLength {
		return xerrors.Errorf("Slice value in field t.Entries was too long")
	}
...
func (t *LegacyEvent) UnmarshalCBOR(r io.Reader) (err error) {
	*t = LegacyEvent{}
	...
	if extra > 0 {
		t.Entries = make([]LegacyEventEntry, extra)
	}

	for i := 0; i < int(extra); i++ {

		var v LegacyEventEntry
		if err := v.UnmarshalCBOR(cr); err != nil {
			return err
		}
...
var lengthBufLegacyEventEntry = []byte{131}

func (t *LegacyEventEntry) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	...
	if _, err := cw.Write(lengthBufLegacyEventEntry); err != nil {
		return err
	}
...
func (t *LegacyEventEntry) UnmarshalCBOR(r io.Reader) (err error) {
	*t = LegacyEventEntry{}
