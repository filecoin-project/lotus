...
func (s *state8) PendingTransactionsMap() (adt.Map, error) {
	return adt8.AsMap(s.store, s.PendingTxns, builtin8.DefaultHamtBitwidth)
}

func (s *state8) PendingTransactionsMapBitWidth() int {
	return builtin8.DefaultHamtBitwidth
}

func (s *state8) PendingTransactionsMapHashFunction() func(input []byte) []byte {
