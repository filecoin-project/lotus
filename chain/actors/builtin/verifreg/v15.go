...
func (s *state15) VerifiedClientDataCap(addr address.Address) (bool, abi.StoragePower, error) {
	...
	return false, big.Zero(), xerrors.Errorf("unsupported in actors v15")
...
func (s *state15) ForEachClient(cb func(addr address.Address, dcap abi.StoragePower) error) error {
	...
	return xerrors.Errorf("unsupported in actors v15")

}

func (s *state15) verifiedClients() (adt.Map, error) {

	return nil, xerrors.Errorf("unsupported in actors v15")
...
func (s *state15) GetAllocation(clientIdAddr address.Address, allocationId verifreg16.AllocationId) (*Allocation, bool, error) {
...
func (s *state15) GetClaim(providerIdAddr address.Address, claimId verifreg16.ClaimId) (*Claim, bool, error) {
