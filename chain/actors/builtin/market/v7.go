...
func (s *dealStates7) StatesArray() adt.Array {
	return s.Array
}

func (s *dealStates7) ArrayBitWidth() int {
...
func (s *dealProposals7) ProposalsArray() adt.Array {
	return s.Array
}

func (s *dealProposals7) ArrayBitWidth() int {
