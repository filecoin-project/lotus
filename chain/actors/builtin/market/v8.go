...
func (s *dealStates8) StatesArray() adt.Array {
	return s.Array
}

func (s *dealStates8) ArrayBitWidth() int {
...
func (s *dealProposals8) ProposalsArray() adt.Array {
	return s.Array
}

func (s *dealProposals8) ArrayBitWidth() int {
