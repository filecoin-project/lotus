...
func (s *dealStates6) StatesArray() adt.Array {
	return s.Array
}

func (s *dealStates6) ArrayBitWidth() int {
...
func (s *dealProposals6) ProposalsArray() adt.Array {
	return s.Array
}

func (s *dealProposals6) ArrayBitWidth() int {
