...
func (s *dealStates3) StatesArray() adt.Array {
	return s.Array
}

func (s *dealStates3) ArrayBitWidth() int {
...
func (s *dealProposals3) ProposalsArray() adt.Array {
	return s.Array
}

func (s *dealProposals3) ArrayBitWidth() int {
