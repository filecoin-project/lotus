...
func (s *dealStates9) StatesArray() adt.Array {
	return s.Array
}

func (s *dealStates9) ArrayBitWidth() int {
...
func (s *dealProposals9) ProposalsArray() adt.Array {
	return s.Array
}

func (s *dealProposals9) ArrayBitWidth() int {
