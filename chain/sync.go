...
func copyBlockstore(ctx context.Context, from, to bstore.XBlockstore) error {
...
func persistMessages(ctx context.Context, bs bstore.XBlockstore, bst *exchange.CompactedMessages) error {
