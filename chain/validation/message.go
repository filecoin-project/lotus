...
var methods = []uint64{
	...
	vchain.StorageMarketConstructor:           actors.SMAMethods.Constructor,
	vchain.StorageMarketAddBalance:            actors.SMAMethods.AddBalance,
	vchain.StorageMarketWithdrawBalance:       actors.SMAMethods.WithdrawBalance,
	vchain.StorageMarketPublishStorageDeals:   actors.SMAMethods.PublishStorageDeals,
	vchain.StorageMarketActivateStorageDeals:  actors.SMAMethods.ActivateStorageDeals,
	vchain.StorageMarketComputeDataCommitment: actors.SMAMethods.ComputeDataCommitment,
