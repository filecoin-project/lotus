...
func (filec *FilecoinEC) CreateBlock(ctx context.Context, s types.Signer, bt *types.BlockTemplate) (*types.FullBlock, error) {
	...
	sig, err := s.WalletSign(ctx, worker, nosigbytes, types.MsgSigningMeta{
		Type: types.MTBlock,
	})
	if err != nil {
