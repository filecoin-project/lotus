...
import "github.com/filecoin-project/lotus/lib/jsonfield"
...
type PreCommit1Out = *jsonfield.JSONBytes[PreCommit1OutRaw]
...
type Commit1Out = *jsonfield.JSONBytes[Commit1OutRaw]

type VanillaStackedProof struct {
	CommDProofs    MerkleProof[Sha256Domain]   `json:"comm_d_proofs"`
	CommRLastProof MerkleProof[PoseidonDomain] `json:"cemm_r_last_proof"`
