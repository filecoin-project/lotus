...
In this Filecoin integration, we implement the following architecture:
  ...
  * Mempool behavior remains governed by standard nonce and fee policies; no special 7702-specific ingress policies are applied.
