...
func ActorControlCmd(getActor ActorAddressGetter, getControlAddresses ControlAddressesGetter) *cli.Command {
	return &cli.Command{
		Name:  "control",
		Usage: "Manage control addresses",
		Subcommands: []*cli.Command{
			actorControlList(getActor, getControlAddresses),
			actorControlSet(getActor),
		},
	}
}

type ControlAddressesGetter func(cctx *cli.Context, actor address.Address) (lapi.AddressConfig, error)

func actorControlList(getActor ActorAddressGetter,
	getControlAddresses ControlAddressesGetter) *cli.Command {
	return &cli.Command{
		Name:  "list",
