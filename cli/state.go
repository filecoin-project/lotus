...
var StateSectorCmd = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		...
		fmt.Println("CommitmentExpiration: ", cliutil.EpochTimeTs(ts.Height(), si.CommitmentExpiration, ts))
		fmt.Println("ProofExpiration: ", cliutil.EpochTimeTs(ts.Height(), si.ProofExpiration, ts))
		fmt.Println()
