...
<div class="exec" id="{{.Hash}}">
 ...
 {{end}}
 <div><span class="slow-false-false">ui</span>, <span class="exit{{IntExit .MsgRct.ExitCode}}">Exit: <b>{{.MsgRct.ExitCode}}</b></span>{{if gt (len .MsgRct.Return) 0}}, Return{{end}}</div>
