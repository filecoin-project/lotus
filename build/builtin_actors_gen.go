...
var EmbeddedBuiltinActorsMetadata []*BuiltinActorsMetadata = []*BuiltinActorsMetadata{{
	...
	Network:     "butterflynet",
	Version:     10,
	ManifestCid: MustParseCid("bafy2bzacec546y4m4ziiohy6gvymnaa4sjeptxbgk2qhvsbffj6ncpj4eeke6"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacearmuc22zvokkg2kychpt6fnwzmkkcannttose2477ozj36qdmr3e"),
		"cron":             MustParseCid("bafk2bzaceafdh2weezo5gxrlgefwty2ixce4qlrqezuzq4ra24wlxfchkgxqi"),
		"datacap":          MustParseCid("bafk2bzacecaw3olueqrmpfang6h7lh2d6gyfgcx5aozdjxlb4hrslzv3fhsb4"),
		"eam":              MustParseCid("bafk2bzacebptvgnxwemqkaw7fo6hfchyeascw73n5sptatywqenhgfs5r5lak"),
		"embryo":           MustParseCid("bafk2bzaceaw3z7opkwf2nqh4jodh2oowyi7wn4rx3iuzohn6puvnvmzx3rwoc"),
		"evm":              MustParseCid("bafk2bzacecwmiyvs242nl27qd2ans3kth46wnez6r3oapzduqr3pqq74ruv7k"),
		"init":             MustParseCid("bafk2bzacedblobitexvxa4dqormxgcaipfzklnj5lbn7vvlugurcuavtujxd2"),
		"multisig":         MustParseCid("bafk2bzacedv6ditdjsyphsirb4d4v5otbxrwewpku3i5okmq7uxgqz3woq57i"),
		"paymentchannel":   MustParseCid("bafk2bzaceayllvjb7a6err7xpmjhwdnewayi2soxvoxdv3r4mtxqu52tkew24"),
		"reward":           MustParseCid("bafk2bzacecomw62ftohkgpr4a2t3xiwmqckzroqvzunlypvkqzjk2owi6upck"),
		"storagemarket":    MustParseCid("bafk2bzacecoo4rodjgnsrannpc36wsc6zxk6sffackkz4fpljc5ke32outnk2"),
		"storageminer":     MustParseCid("bafk2bzacecatutnhrwwmufcchb5lxl6ibawvacofpnej7u7gx2b5slezwn5tq"),
		"storagepower":     MustParseCid("bafk2bzaceae5ewasrgr74zjazbkqek2dqfmgikn72g4e7llksnk24hzu7eiv4"),
		"system":           MustParseCid("bafk2bzaceacyuakovtquu5q6z644dhwotzqmwceij2pqnxjf7dflo6qqeyhoc"),
		"verifiedregistry": MustParseCid("bafk2bzaceamptnlun345k4tszj3daj57qqv4b4znuzf7wqn4mt3s7puigjoss"),
	},
}, {
	...
	Network:     "calibrationnet",
	Version:     10,
	ManifestCid: MustParseCid("bafy2bzacedx2rafkyja4qbxyro2khxfpa4qlzsbdazgei5i4zmnmenmiixyv4"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacecvhbjmbn5mn75equp5edplugxwxohbzoayp655bin2npohhgg7ge"),
		"cron":             MustParseCid("bafk2bzacec5mixel64qenygvnfbd3sz3dhgjsxjx2wxrbppkgxc4gc4bzuo46"),
		"datacap":          MustParseCid("bafk2bzacecjumvdlncmu4z2pdvtdttjwvmnikf2g7rthgp4bcb5i6nkgehtni"),
		"eam":              MustParseCid("bafk2bzacebrxcdu4rkmkkrhflu4jb2wwmzbik6q7z7cadkhyu34sb6sukis46"),
		"embryo":           MustParseCid("bafk2bzaceaw3z7opkwf2nqh4jodh2oowyi7wn4rx3iuzohn6puvnvmzx3rwoc"),
		"evm":              MustParseCid("bafk2bzaceb2xrfmkrglsywbl4re2cjua3ebi4bigldfifs7y5dptqunatj626"),
		"init":             MustParseCid("bafk2bzacea56hr6meu7sd5rnm63ec3extl3crgmyzujkwcbjucjtupgent2aa"),
		"multisig":         MustParseCid("bafk2bzaced2kvxezt2savedoq36ildfj5afupfgccjtn32rq4jqan6lo23peo"),
		"paymentchannel":   MustParseCid("bafk2bzacecp3nfzl6p562hwy524vc2y7s4gikirf3sg3tj67k43qv4sgkuul4"),
		"reward":           MustParseCid("bafk2bzaceadbymfswp7h7zyswi2wcqxhf4lswvw23owceovkbyuyli7ojsmt4"),
		"storagemarket":    MustParseCid("bafk2bzacec2fnvolht5prf23uupnm3smrlu233ordvav5zzbqqrglpzupec6u"),
		"storageminer":     MustParseCid("bafk2bzacedb5yv22oqb32pc4423xjb7sraxcyx7pokxx6z3gwkgozqdctu7j6"),
		"storagepower":     MustParseCid("bafk2bzacedr4xvqebihlrd5bnnyp64rx2y7ulk4ofhtfi6aslol4lx7dqrjoq"),
		"system":           MustParseCid("bafk2bzacec2yqvrljnqpk7s2arz5hnyabknvwsfnpze2hkk4j6blc6ydx72fs"),
		"verifiedregistry": MustParseCid("bafk2bzacebwgo2zjf7xvr3roujvrxxrj5meingifjl2lqfu4zicxh3bm6dcsi"),
	},
}, {
	...
	Network:     "caterpillarnet",
	Version:     10,
	ManifestCid: MustParseCid("bafy2bzaced45cr724qlitroietzvdpgz3xvuprhzx5ps3u4k263mtqm6ix7vc"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzaceawpgvfsfcg4mmbdpkt6gobwljebf5r333wd7judsxkepddti7zky"),
		"cron":             MustParseCid("bafk2bzacecqlecjbgxphnd4xgdmp22aj32e2ycatpgix7lo4jai4drfw7hnsa"),
		"datacap":          MustParseCid("bafk2bzacedumn7nrwmoq2hglwbhiz63yvc346aje6od2x6bnub4m5gqlk3pjk"),
		"eam":              MustParseCid("bafk2bzacebhbsqp5446fetvy3cvvz7mybktd5zbaqu4nlf25onv3sfxpvkkn4"),
		"embryo":           MustParseCid("bafk2bzaceaw3z7opkwf2nqh4jodh2oowyi7wn4rx3iuzohn6puvnvmzx3rwoc"),
		"evm":              MustParseCid("bafk2bzacecupe6ndbpcb5srbc465avuol6qtamcfs2ir5cl2wepwam4od6k6c"),
		"init":             MustParseCid("bafk2bzaceb6v3wjrqbbn2qwsdh27jtioipw5dlm5iobg73pm2xal4dcu3mqh6"),
		"multisig":         MustParseCid("bafk2bzaceak3h34vbyzay32mraj7zewpzztpurkckzh4s5gkjrzw63euptor4"),
		"paymentchannel":   MustParseCid("bafk2bzacebyhliabvbh6vsz7bfjenzsl7r7htfeedbni4wm4i7w6pjriuk6xo"),
		"reward":           MustParseCid("bafk2bzacearzuev3acumro4htl3vlkmvqsi7mr34ao3hmigcmvpdanfiheiai"),
		"storagemarket":    MustParseCid("bafk2bzaced7xt2z73u6qxahzjivmx4hrfjsxtotpzqk56fhscrjb772e74l4e"),
		"storageminer":     MustParseCid("bafk2bzacedyixw7g7l5kjkuxoopbjk6i7knnmhruesemes2h66dk2eywmnwdy"),
		"storagepower":     MustParseCid("bafk2bzacedaxp7der65u6glx6iikpzsfceklb6sywfvejskwaxpbvwk7a7g4s"),
		"system":           MustParseCid("bafk2bzacebzy2nkrmqvaehu7zel6mq7b46ybtibspilpdgb4ycv5i2esmv2go"),
		"verifiedregistry": MustParseCid("bafk2bzacecogsrrxxlrmms7lq72tcyxhm2mu47ecnlvpzuwsoz4dbkd52vecm"),
	},
}, {
	Network:     "devnet",
	Version:     8,
	...
	Network:     "devnet",
	Version:     10,
	ManifestCid: MustParseCid("bafy2bzacedjvse5gf7rb4xzzy5prharoowk226ypd2bdsmuao2f372riqjcj6"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzaceaq7wekv3arfnnmcznpr27pikhhjvbvdjal6rs3meutzo33nvvzjk"),
		"cron":             MustParseCid("bafk2bzacebq4h2ktc3e3cwssadr7xbly3tibe7zg3kvuntwdn2oer63cn3il6"),
		"datacap":          MustParseCid("bafk2bzacebpzl4v4rcfmwomgzky7xxt5dpgdkftmic36chfzq7yofokva5vse"),
		"eam":              MustParseCid("bafk2bzaced5qcdpmr7hntyaah2ovmovifhidpaiyxjkgv7743z3yglw54adpq"),
		"embryo":           MustParseCid("bafk2bzaceaw3z7opkwf2nqh4jodh2oowyi7wn4rx3iuzohn6puvnvmzx3rwoc"),
		"evm":              MustParseCid("bafk2bzaceblfwgyh7eo5p6vwszlz7x2d5tcywthcojhvrsh2szlyktitu4d44"),
		"init":             MustParseCid("bafk2bzacede6qef6h5mc5jx5vb3fo5kf542tuhq7wnaiibqzziqsoypzrkham"),
		"multisig":         MustParseCid("bafk2bzacebrcurql6afnhx6up2p6lki57fcd7m6caqpdn3puondk2diy5h2ac"),
		"paymentchannel":   MustParseCid("bafk2bzacedwkikhex6mmk2odxa4bigrg6g4auk4zt574jpmtdvnm4fcofed5e"),
		"reward":           MustParseCid("bafk2bzacebtcn4yatavdsikiqui3asxqcnjf56r6y7vht6oru5yr4rcgxi2ua"),
		"storagemarket":    MustParseCid("bafk2bzaceb2o2t2azjq7clhnvsu3ddrsgwugfcx3rcvihky3dlkdgfnbn7c32"),
		"storageminer":     MustParseCid("bafk2bzaceaqzsjnn3xepxmnxdaq63ameyhqz4rexmfprweh7wud3hku52kojo"),
		"storagepower":     MustParseCid("bafk2bzaceccgxyjbwosvkm3hg5xtb3xg2eyl2gatx3vwl7jpt3asn3qunymxo"),
		"system":           MustParseCid("bafk2bzacec2ikmpsqa6rmccuvqpqobgqaneihtqfzg6odjm6s5gcb3qp2oz24"),
		"verifiedregistry": MustParseCid("bafk2bzacedzdpf6mqxke7skbsmc7tqqvnguns7zfieelbgqfcnhfodfkonito"),
	},
}, {
	Network:     "mainnet",
	Version:     8,
	...
	Network:     "mainnet",
	Version:     10,
	ManifestCid: MustParseCid("bafy2bzacea3zuy77rjkdo52gqp6llp4ztexd7mwsflrtckg55rugkyoqdfoly"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacec4ozbimfoas4vsliwjvat23nu5wfvf6viamepasx5qahjmwbd6aq"),
		"cron":             MustParseCid("bafk2bzacecz44fxjzho4olbcznsbtft7yugqodlsoua6nj4bj5auqjxhc3rf4"),
		"datacap":          MustParseCid("bafk2bzacecizeaum6ceo2v3slmp7t44snazqhhyip6vn4v4zretjmhsg57oay"),
		"eam":              MustParseCid("bafk2bzacealu4ls4nhuqhktdgfl7q7u43ywuqgtvhqtvykzts7vohhfuuwe26"),
		"embryo":           MustParseCid("bafk2bzaceaw3z7opkwf2nqh4jodh2oowyi7wn4rx3iuzohn6puvnvmzx3rwoc"),
		"evm":              MustParseCid("bafk2bzacedgragc2ffmvym6ii6dij37nxocueudjhrofm4fngwzrldz4gxmmu"),
		"init":             MustParseCid("bafk2bzacedfspwartem2rxs2rplcqwtpcbusabjgv45fkdldxxlaiiqjnwgwg"),
		"multisig":         MustParseCid("bafk2bzacea3f3tl6gyhcvhcyxyvcb2iky7ebvbhs3fz6bj2uss7twelfe5esw"),
		"paymentchannel":   MustParseCid("bafk2bzacebzpqn3opdmaxxjsyrzrs6wyguyui4fjjr23wyltwmesemj2vjm52"),
		"reward":           MustParseCid("bafk2bzacec7zdpkajlutq6hlh4ytskhbynhidpch4bffbdxs3kz6yjvpgq4zg"),
		"storagemarket":    MustParseCid("bafk2bzacebjnjupmkt7mdo5jigovgyvowlouvgscos2evdbyg5cq6epqge76a"),
		"storageminer":     MustParseCid("bafk2bzacebqvp3qkowdo76cjrm4coc7xmpuv4xz6ekbbattbzl5hihdxmwh44"),
		"storagepower":     MustParseCid("bafk2bzacedqnme7adohd44c5tvzr2nz4wmu7zbbkek4qsavxap3u3xeun6rlq"),
		"system":           MustParseCid("bafk2bzacebaewbj6jf5wh7ap64pdgihhsqt4kdtklottv77i2fwhityk47msi"),
		"verifiedregistry": MustParseCid("bafk2bzaced3vvsqzdjy3act3dg62qz4wth3iq3hwkzaldxvywzj2bkxmlb73m"),
	},
}, {
	Network:     "testing",
	Version:     8,
	...
	Network:     "testing",
	Version:     10,
	ManifestCid: MustParseCid("bafy2bzaced2ddrj7mtqkrcexb2tnirbfwpuhgdygmcygpgzxzblexhofhis34"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacebux6zjskf7k6hsxzzl5ukfxfj7caijc3ef6wnb5z65j2yka2pzzw"),
		"cron":             MustParseCid("bafk2bzacea7gz2livj4vdeifkw3fwctyujlo57yjoswoenw4vbykouycs7esm"),
		"datacap":          MustParseCid("bafk2bzacebvdbcfc2xz2rfavcldywhsymphqqn5ku5z3756lbfmv6mgdoknnu"),
		"eam":              MustParseCid("bafk2bzaceczqwthbozrzwj7f5ghcpg7vqre6bupmnmetzey5q2y6y4v6udy64"),
		"embryo":           MustParseCid("bafk2bzaceaw3z7opkwf2nqh4jodh2oowyi7wn4rx3iuzohn6puvnvmzx3rwoc"),
		"evm":              MustParseCid("bafk2bzaced757knarxyhyghhojlolqtbcviluxz4o2oe4swklxxdg3b3o7ad4"),
		"init":             MustParseCid("bafk2bzacecoa2qx6mlmkkpshku5s5l2peo75uxexzouihwuxvjqbwmu5rkons"),
		"multisig":         MustParseCid("bafk2bzacedboz7qiq4cqbu6uz44eqszlotyhpo6juegit42sgtuiqaamxvga2"),
		"paymentchannel":   MustParseCid("bafk2bzacecsgxjhwukxwc4h7kdi5lufjmfpof6j3mmv2hhucbmbocamq7g2oo"),
		"reward":           MustParseCid("bafk2bzacediouvmvxnuuh5axlciosjptjccvfhi6lekd3etr7ccnpdf5jhacg"),
		"storagemarket":    MustParseCid("bafk2bzacedv42c5f5u45ivrovg4mq35xvqllpw6r5fg7ptx2pozitlkaziyvk"),
		"storageminer":     MustParseCid("bafk2bzaceay7e23j6meay43zmhr3qyubpm5a3tcvzrig7mha7im755yzhia4a"),
		"storagepower":     MustParseCid("bafk2bzaced43c3zm6bsuv363iyumvv7xottynhe26fp2dc33bz7onvjgazddm"),
		"system":           MustParseCid("bafk2bzaceb4wsgzw7q25k4zkihbevkdbjx4pblnwmu7z37wayrye43xyju7ig"),
		"verifiedregistry": MustParseCid("bafk2bzacebry7lumkm35pkamf2evywcq4pnrr4ew4bts3hmgf3rdbnrorijus"),
	},
}, {
	...
	Network:     "testing-fake-proofs",
	Version:     10,
	ManifestCid: MustParseCid("bafy2bzacebipqomvpljf7bqej2gdlq7f5is2ut73jvgfonhagccays4r4jniy"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacebux6zjskf7k6hsxzzl5ukfxfj7caijc3ef6wnb5z65j2yka2pzzw"),
		"cron":             MustParseCid("bafk2bzacea7gz2livj4vdeifkw3fwctyujlo57yjoswoenw4vbykouycs7esm"),
		"datacap":          MustParseCid("bafk2bzacebvdbcfc2xz2rfavcldywhsymphqqn5ku5z3756lbfmv6mgdoknnu"),
		...
		"reward":           MustParseCid("bafk2bzacediouvmvxnuuh5axlciosjptjccvfhi6lekd3etr7ccnpdf5jhacg"),
		"storagemarket":    MustParseCid("bafk2bzacedv42c5f5u45ivrovg4mq35xvqllpw6r5fg7ptx2pozitlkaziyvk"),
		"storageminer":     MustParseCid("bafk2bzaced4oceztj4ovbzap6lkrbflprzspuifw6zjl75tk2uit4wfy6xn3k"),
		"storagepower":     MustParseCid("bafk2bzaceb2rzyapsg2ilnjaglkrfxxi5lvvbbnfs7ahqh3c3fzjecfwhwvoc"),
		"system":           MustParseCid("bafk2bzaceb4wsgzw7q25k4zkihbevkdbjx4pblnwmu7z37wayrye43xyju7ig"),
		"verifiedregistry": MustParseCid("bafk2bzacebry7lumkm35pkamf2evywcq4pnrr4ew4bts3hmgf3rdbnrorijus"),
	},
}}
