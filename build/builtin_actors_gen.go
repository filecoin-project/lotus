...
var EmbeddedBuiltinActorsMetadata []*BuiltinActorsMetadata = []*BuiltinActorsMetadata{{
	...
	Network:     "devnet-wasm",
	Version:     10,
	ManifestCid: MustParseCid("bafy2bzacea6erktxhnbm4b2ogtt5ajapk3qwvlniggxz5z74s77on6l5ryrcc"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacecthokd5zxer2lakk4u4ta7xbjbbpa7ct6sjhrfhbmpfeiqzau5va"),
		"cron":             MustParseCid("bafk2bzaceaumuzrxaruffs652ptailigfaoz756e3so4rkxnqv5d6vxqcrdqw"),
		"datacap":          MustParseCid("bafk2bzacedsj45olumr3gqisbd5ryjls5xb4xq4hnuq7t6tkh6w43bqlkazt2"),
		"eam":              MustParseCid("bafk2bzacedkx2enkrvh6j5dpzayjlupm7i32oymun7sfmf2brcai32htff4ou"),
		"embryo":           MustParseCid("bafk2bzaceaw3z7opkwf2nqh4jodh2oowyi7wn4rx3iuzohn6puvnvmzx3rwoc"),
		"evm":              MustParseCid("bafk2bzacec4ii6kdjsgijw2rww5i44uxqadeaouip2s6cordq2tcbwnsazxsw"),
		"init":             MustParseCid("bafk2bzacedphzryfgo5zkrzyyseoz2d7xocojupdkj6dlcdmj4bluapjjvysi"),
		"multisig":         MustParseCid("bafk2bzacedk3gdbpommnnxe7hqchlatlq5gydwv2a46sizcluh5s64b2kz7je"),
		"paymentchannel":   MustParseCid("bafk2bzaceb27hf6hmshhxuyaiasrrokgyro3jt6dtcx4te777myw4aag2qbfe"),
		"reward":           MustParseCid("bafk2bzacebjckfdmxls2tl3jkwmsdm3u72inzryqsw6emf2ltlhgqxazhgivw"),
		"storagemarket":    MustParseCid("bafk2bzacecnhqbjr4lhd26zjnba4mqpyzjy2o3dunoihe3vhbft2vdtu6mcgq"),
		"storageminer":     MustParseCid("bafk2bzacebfwaxcjnqqkwwzkjcizsdf3pawocrz3ulsip3jxasvm4kaox2gqe"),
		"storagepower":     MustParseCid("bafk2bzacecu3icznly6ix76ghxjtiqu2xqjpfwlv7lhl32tle26wsmcmkzx2s"),
		"system":           MustParseCid("bafk2bzacecrxvjdz333z5z4oohuuorfrbhbuqzgs2qmtd2yxey3ysct55ojdg"),
		"verifiedregistry": MustParseCid("bafk2bzaceafw66n662w4yjcfxglhw73t6y6366fiu5ccx4hwxlfbiflteiaes"),
	},
}, {
	Network:     "mainnet",
	Version:     8,
	...
	Network:     "wallaby",
	Version:     10,
	ManifestCid: MustParseCid("bafy2bzacedzno752ifkh2tyi2cv3wi2jptb6vnjwacsz3td4lc7rbzjidkyv4"),
	Actors: map[string]cid.Cid{
		"account":          MustParseCid("bafk2bzacebnirry7i3o3oz5gavmuphiqftcze2wfcr5nzpnp2t7c22nwh7vgg"),
		"cron":             MustParseCid("bafk2bzaced4qkb3hsbqphcklcpyhoq2ghq4lwaps6qlhnf4j7yxhcfel2zapi"),
		"datacap":          MustParseCid("bafk2bzaceafnyfaujekh4cpais3q2knd2mtpdgphnlsyadptswtzs57f2daic"),
		"eam":              MustParseCid("bafk2bzacecbryegfr5unsfvmyrn54vm53jtfnzqc62zwroovyle2z3l67s4vs"),
		"embryo":           MustParseCid("bafk2bzaceaw3z7opkwf2nqh4jodh2oowyi7wn4rx3iuzohn6puvnvmzx3rwoc"),
		"evm":              MustParseCid("bafk2bzaceaun4l4pp74g2lvysmg5yzcjvlvcqw5j5z5364aymnk4e3cnlahsu"),
		"init":             MustParseCid("bafk2bzacedcqb6vbqks3xmpxyolzi4idmv23feahljg6yab7gbhskvu2zcxna"),
		"multisig":         MustParseCid("bafk2bzaceahihxewyov7a4fatz52zjxc3szlauc3mc22oyh6lwccnix7drnuo"),
		"paymentchannel":   MustParseCid("bafk2bzacebc7eqd3kafdcyyfx6pddne7hiugsgi42jkvprfwdymkt4poahth4"),
		"reward":           MustParseCid("bafk2bzaceccl47w6egbhwucjy2lq7two25c5as2p6idevqm3bkwvmqbpiogqy"),
		"storagemarket":    MustParseCid("bafk2bzaceck3xrowc5lqbnjhphy5l4gjtmfzvb2lx547wfjp5tv3ojxcnie52"),
		"storageminer":     MustParseCid("bafk2bzaced2ue3ihcxm4csmnw4uoxtnfwza4tlvxuxu4m7425l5cyatzlqulo"),
		"storagepower":     MustParseCid("bafk2bzacedigtadxsz3stozhtf2terjxjbzehu7pl47htewpeiv2iwamctkza"),
		"system":           MustParseCid("bafk2bzacecchukhqwjsyuipanig7wahkl6hnzt3rgor3paeix57e2vdpjg4ao"),
		"verifiedregistry": MustParseCid("bafk2bzacec2vnattt4rspseff2c76mchncathrcow2emlnvrnjklcoc6sibp4"),
	},
}}
