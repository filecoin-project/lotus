...
var EmbeddedBuiltinActorsMetadata []*BuiltinActorsMetadata = []*BuiltinActorsMetadata{{
	...
	Actors: map[string]cid.Cid{
		...
		"datacap":          MustParseCid("bafk2bzaceb63tm5w6vqkpnelz3eka2uarhi3szpo7mtaa66ntk3k5ihepduxq"),
		"eam":              MustParseCid("bafk2bzacecdpepokxotoz7kfcailqwxmzvnn5hcrrjjxkgxremowyz3aq66uq"),
		"ethaccount":       MustParseCid("bafk2bzaceczu3q7bnglexatg7gfpyitmc4e6jpq42khyxfunr2gikqacpuyo2"),
		"evm":              MustParseCid("bafk2bzacedmufy25hmtezlim7asrka42gx6a4ls7pa7u7eq7qtjldzeuwmm7a"),
		"init":             MustParseCid("bafk2bzacedqikacxas7sgbrtu6rz2eo3frzsr5s3lel5aric4wo5y6zf7nfyc"),
		"multisig":         MustParseCid("bafk2bzacebkhm5z6ddv7fcerg3d7fs4nobe2tjepq423br2tfuqig3f4gdyq2"),
	...
	Actors: map[string]cid.Cid{
		...
		"datacap":          MustParseCid("bafk2bzacebhy5jyzen65wjd64bubmfdklqoqgqemapjeuvdcl2nhqg7okrbrc"),
		"eam":              MustParseCid("bafk2bzaceaucaipe5y2cek6z5ywqaixwchpftvfnxmwp5pgoggzxmvgz2rrts"),
		"ethaccount":       MustParseCid("bafk2bzaceczkurjb5vbxjwsjkwsgnb77d23je5ezuk7ok46rh7rhrxxj5xmmw"),
		"evm":              MustParseCid("bafk2bzaceb6idcomyr6pwpf3zb62x7ovj2k3qoxo7e7hvncschbdesertobks"),
		"init":             MustParseCid("bafk2bzaced4bch6um4v3m34wyh74ohzj4sovy7v5a2d6iashcmuekwdzt74pc"),
		"multisig":         MustParseCid("bafk2bzacea3xyhpbd7yczzdepxky6luc4leym5nrakfzyvomx4b6eabvjhyu2"),
	...
	Actors: map[string]cid.Cid{
		...
		"datacap":          MustParseCid("bafk2bzacebv2u2k6a2js66fqrwau27r7nytfslo3sp23s2m7obrd6cgnzdnby"),
		"eam":              MustParseCid("bafk2bzacedt3dqwjq2ovrgvg7f6razhncrti5s5rvzjl37plwfs5emccttiyi"),
		"ethaccount":       MustParseCid("bafk2bzaceasnimeqc2gqbve6tqip5aeb3ajfo5mqkmwvwzodhuxgmw52z33hy"),
		"evm":              MustParseCid("bafk2bzacecddtcs7wvezueei43dabjcjsp2vf4gp4uwv4peohmqwm2myzmtao"),
		"init":             MustParseCid("bafk2bzacedne4ldixnynpgxugrnagwtlqw7ej5b5kshxrvlkohnpwx26o467k"),
		"multisig":         MustParseCid("bafk2bzaceb73pncvgso5ru4nis6pmsnfipuqbevir53zjl6zd5p5fpzvys5go"),
	...
	Actors: map[string]cid.Cid{
		...
		"datacap":          MustParseCid("bafk2bzaceaf3sc63uol2i22fayu4fc2s56tknpdzj6jaeprf6gb7fs3tgpnuq"),
		"eam":              MustParseCid("bafk2bzaceakpo3wfbr3f5unounzno7hsvkbdt5gb4yfaa7lmytcx2sgdfjvlw"),
		"ethaccount":       MustParseCid("bafk2bzacea5kfvp7ztgugxka4ovqzy6lm66y7l7wpihw4udxr46rsfjkxju6o"),
		"evm":              MustParseCid("bafk2bzacearapyd6yujmq25mxlkhp6xnqzuymxgzneafsl75wjtvvquylx3cw"),
		"init":             MustParseCid("bafk2bzacecbnb2jpoxss4hsx3jwjx6y3uvga3rrfteqkaua74bwf5755yiez2"),
		"multisig":         MustParseCid("bafk2bzacecljjoxloh2fmezuipusehspqsgg5tz43fr5sbrgtlccnvo53isfu"),
	...
	Actors: map[string]cid.Cid{
		...
		"datacap":          MustParseCid("bafk2bzacecqttzejoqhfzgbpqp3u5l2rey5wrvw2haekf4kwqeq5basikgri6"),
		"eam":              MustParseCid("bafk2bzacedzvmit7c5ojfn7cehasqc7eirxb5lwymxiuuyomuphgdjradewzs"),
		"ethaccount":       MustParseCid("bafk2bzacealiu2z25pqe7ejfuby4hrsn3faowmreqyeoh3syp75ej3hbcrjom"),
		"evm":              MustParseCid("bafk2bzacecnswpgw2hvbewt2d63s6ksmcbj5f6242yte2u5icvg2gxkb3ognq"),
		"init":             MustParseCid("bafk2bzaced6rkgqdovhtvzxlhio5m7guxmroep3miqbrci6fnjlgsydb66vxs"),
		"multisig":         MustParseCid("bafk2bzacedakyip5swfxuzw32zk4i2ugicfij7gj44fwzxswg65ld2ojnpkua"),
	...
	Actors: map[string]cid.Cid{
		...
		"datacap":          MustParseCid("bafk2bzacebgbzslbgzsbrgjgc3zxtrl4alkf6uc5osttc4vbjra4zhezoqucg"),
		"eam":              MustParseCid("bafk2bzaceaihg3gt6ojmnnvcyacze4pqrhtkox7wzktrvolqvvh2yrn3vslxk"),
		"ethaccount":       MustParseCid("bafk2bzaceccdpajhiq6clwuo6zfea7osargc6v7feaorjygck5trggbpzho7u"),
		"evm":              MustParseCid("bafk2bzaceasgo3bagrxz52iejbmhrg4o7sexhckzzc4eibkzcvgkw6yap46ms"),
		"init":             MustParseCid("bafk2bzacec7wnai6aj7ndowbhjjmnp6bjh7ssaty26otyzbewdqaat756jcbi"),
		"multisig":         MustParseCid("bafk2bzaceaukbommthw5uqotixpgeauvi32qzytp7pabp74jvj3ecdwgh74z4"),
