...
var DrandConfigs = map[buildconstants.DrandEnum]dtypes.DrandConfig{
	...
	buildconstants.DrandIncentinet: {
		IsChained:     true,
...
func DrandConfigSchedule() dtypes.DrandSchedule {
	...
	for start, network := range buildconstants.DrandSchedule {
