...
var NetworkBundle = "devnet" // Use devnet bundle for testing

// NOTE: DO NOT change this unless you REALLY know what you're doing. This is consensus critical.
const ActorDebugging = true // Enable debugging for test network

const GenesisNetworkVersion = network.Version0

const BootstrappersFile = "w3m-lotus-512.pi"
...
var ConsensusMinerMinPower = abi.NewStoragePower(512 << 20) // 512 MiB minimum power for testing
var PreCommitChallengeDelay = abi.ChainEpoch(10) // Shorter delay for testing
...
func init() {
	...
	BuildType = BuildDefault // Custom build, not mainnet or 2k
}

const BlockDelaySecs = uint64(10) // 10 seconds for faster testing
