...
- feat: add `lotus-shed market settle-deal` CLI command, This command can submit the message to the chain as soon as possible and automatically batch it without waiting for the message to be packaged.
