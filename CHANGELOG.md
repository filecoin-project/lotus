...
- fix(vm): cap gas for `StateCall` and other simulated implicit-message execution, defaulting to the network block gas limit with an operator-configurable `API.StateCallGasLimit` override. ([filecoin-project/lotus#TODO](https://github.com/filecoin-project/lotus/pull/TODO))
