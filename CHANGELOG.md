...
- feat(cli): warn before nv29 that `lotus filplus` and `lotus-shed verifreg` write commands will retire at the upgrade. ([filecoin-project/lotus#13798](https://github.com/filecoin-project/lotus/pull/13798))
