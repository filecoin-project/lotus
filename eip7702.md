...
3. Message Conversion and Actor Integration (Phase 2)
-----------------------------------------------------
...
6. Receipt and RPC Updates
--------------------------

### 6.1 `node/impl/eth/transaction.go`
...
8. Test Harness and Integration Tests
-------------------------------------
