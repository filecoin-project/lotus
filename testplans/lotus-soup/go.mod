...
require (
	...
	github.com/filecoin-project/lotus v1.0.0 // always replace-ed with the current version below
...
// Instead of building against a specific version of lotus, always build
// against the repo we just checked out
