...
<p align="center">
  ...
  <a href=""><img src="https://img.shields.io/badge/golang-%3E%3D1.24.6-blue.svg" /></a>
  <br>
</p>
...
To build Lotus, you need a working installation of [Go 1.24.6 or higher](https://golang.org/dl/):

```bash
wget -c https://golang.org/dl/go1.24.6.linux-amd64.tar.gz -O - | sudo tar -xz -C /usr/local
```
