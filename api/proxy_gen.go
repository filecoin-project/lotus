...
type FullNodeStruct struct {
	...
	Internal struct {
		...
		ChainExportRange func(p0 context.Context, p1 bool, p2 types.TipSetKey, p3 types.TipSetKey) (<-chan []byte, error) `perm:"read"`
...
func (s *FullNodeStruct) ChainExportRange(p0 context.Context, p1 bool, p2 types.TipSetKey, p3 types.TipSetKey) (<-chan []byte, error) {
...
func (s *FullNodeStub) ChainExportRange(p0 context.Context, p1 bool, p2 types.TipSetKey, p3 types.TipSetKey) (<-chan []byte, error) {
	return nil, ErrNotSupported
}
