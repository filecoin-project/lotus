...
type FullNodeStruct struct {
	...
	Internal struct {
		...
		WalletMsigImport func(p0 context.Context, p1 address.Address) error `perm:"admin"`
...
func (s *FullNodeStruct) WalletMsigImport(p0 context.Context, p1 address.Address) error {
	if s.Internal.WalletMsigImport == nil {
		return ErrNotSupported
	}
	return s.Internal.WalletMsigImport(p0, p1)
}

func (s *FullNodeStub) WalletMsigImport(p0 context.Context, p1 address.Address) error {
	return ErrNotSupported
}
...
func (s *WalletStruct) WalletMsigImport(p0 context.Context, p1 address.Address) error {
	if s.Internal.WalletMsigImport == nil {
		return ErrNotSupported
	}
	return s.Internal.WalletMsigImport(p0, p1)
...
func (s *WalletStub) WalletMsigImport(p0 context.Context, p1 address.Address) error {
	return ErrNotSupported
}
