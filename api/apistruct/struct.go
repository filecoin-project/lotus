...
type FullNodeStruct struct {
	...
	Internal struct {
		...
		MsigCreate              func(context.Context, uint64, []address.Address, abi.ChainEpoch, abi.ChainEpoch, types.BigInt, address.Address) (cid.Cid, error)                 `perm:"sign"`
...
func (c *FullNodeStruct) MsigCreate(ctx context.Context, req uint64, addrs []address.Address, vestingStart abi.ChainEpoch, vestingDuration abi.ChainEpoch, val types.BigInt, src address.Address) (cid.Cid, error) {
	return c.Internal.MsigCreate(ctx, req, addrs, vestingStart, vestingDuration, val, src)
}
