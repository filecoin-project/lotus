...
type FullNodeStruct struct {
	...
	Internal struct {
		...
		ClientListDeals func(p0 context.Context, p1 storagemarket.ListDealsPageParams) ([]api.DealInfo, error) `perm:"write"`
...
func (s *FullNodeStruct) ClientListDeals(p0 context.Context, p1 storagemarket.ListDealsPageParams) ([]api.DealInfo, error) {
	return s.Internal.ClientListDeals(p0, p1)
}
