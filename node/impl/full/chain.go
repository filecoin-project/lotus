...
func (m *ChainModule) ChainNotify(ctx context.Context) (<-chan []*store.HeadChange, error) {
...
func (m *ChainModule) ChainGetPath(ctx context.Context, from, to types.TipSetKey) ([]*store.HeadChange, error) {
