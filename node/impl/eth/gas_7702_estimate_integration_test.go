...
func (m *mockEGTipsetResolver) GetTipSetByHash(ctx context.Context, h ethtypes.EthHash) (*types.TipSet, error) { return m.ts, nil }
func (m *mockEGTipsetResolver) GetTipsetByBlockNumber(ctx context.Context, blkParam string, strict bool) (*types.TipSet, error) { return m.ts, nil }
func (m *mockEGTipsetResolver) GetTipsetByBlockNumberOrHash(ctx context.Context, p ethtypes.EthBlockNumberOrHash) (*types.TipSet, error) { return m.ts, nil }

type mockEGChainStore struct{ ts *types.TipSet }
func (m *mockEGChainStore) GetHeaviestTipSet() *types.TipSet { return m.ts }
func (m *mockEGChainStore) GetTipsetByHeight(ctx context.Context, h abi.ChainEpoch, ts *types.TipSet, prev bool) (*types.TipSet, error) { return m.ts, nil }
func (m *mockEGChainStore) GetTipSetFromKey(ctx context.Context, tsk types.TipSetKey) (*types.TipSet, error) { return m.ts, nil }
func (m *mockEGChainStore) GetTipSetByCid(ctx context.Context, c cid.Cid) (*types.TipSet, error) { return m.ts, nil }
func (m *mockEGChainStore) LoadTipSet(ctx context.Context, tsk types.TipSetKey) (*types.TipSet, error) { return m.ts, nil }
func (m *mockEGChainStore) GetSignedMessage(ctx context.Context, c cid.Cid) (*types.SignedMessage, error) { return nil, nil }
func (m *mockEGChainStore) GetMessage(ctx context.Context, c cid.Cid) (*types.Message, error) { return nil, nil }
func (m *mockEGChainStore) BlockMsgsForTipset(ctx context.Context, ts *types.TipSet) ([]store.BlockMessages, error) { return nil, nil }
func (m *mockEGChainStore) MessagesForTipset(ctx context.Context, ts *types.TipSet) ([]types.ChainMsg, error) { return nil, nil }
func (m *mockEGChainStore) ReadReceipts(ctx context.Context, root cid.Cid) ([]types.MessageReceipt, error) { return nil, nil }
func (m *mockEGChainStore) ActorStore(ctx context.Context) adt.Store { return nil }

type mockEGStateManager struct{}
func (m *mockEGStateManager) GetNetworkVersion(ctx context.Context, height abi.ChainEpoch) network.Version { return network.Version16 }
func (m *mockEGStateManager) TipSetState(ctx context.Context, ts *types.TipSet) (cid.Cid, cid.Cid, error) { return cid.Undef, cid.Undef, nil }
...
func (m *mockEGStateManager) LookupIDAddress(ctx context.Context, addr address.Address, ts *types.TipSet) (address.Address, error) { return addr, nil }
func (m *mockEGStateManager) LoadActor(ctx context.Context, addr address.Address, ts *types.TipSet) (*types.Actor, error) { return nil, nil }
func (m *mockEGStateManager) LoadActorRaw(ctx context.Context, addr address.Address, st cid.Cid) (*types.Actor, error) { return nil, nil }
func (m *mockEGStateManager) ResolveToDeterministicAddress(ctx context.Context, addr address.Address, ts *types.TipSet) (address.Address, error) { return addr, nil }
func (m *mockEGStateManager) ExecutionTrace(ctx context.Context, ts *types.TipSet) (cid.Cid, []*api.InvocResult, error) { return cid.Undef, nil, nil }
func (m *mockEGStateManager) Call(ctx context.Context, msg *types.Message, ts *types.TipSet) (*api.InvocResult, error) { return nil, nil }
func (m *mockEGStateManager) CallOnState(ctx context.Context, stateCid cid.Cid, msg *types.Message, ts *types.TipSet) (*api.InvocResult, error) { return nil, nil }
...
func (m *mockEGStateManager) ApplyOnStateWithGas(ctx context.Context, stateCid cid.Cid, msg *types.Message, ts *types.TipSet) (*api.InvocResult, error) { return nil, nil }
func (m *mockEGStateManager) HasExpensiveForkBetween(parent, height abi.ChainEpoch) bool { return false }

type mockEGMessagePool struct{ ts *types.TipSet; cfg types.MpoolConfig }
func (m *mockEGMessagePool) PendingFor(ctx context.Context, a address.Address) ([]*types.SignedMessage, *types.TipSet) { return nil, m.ts }
