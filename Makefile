...
build-images:
	...
	docker build -t "iptestground/oni-runtime:v3-debug" -f "docker-images/Dockerfile.oni-runtime-debug" "docker-images"

push-images:
	docker push iptestground/oni-buildbase:v5
	docker push iptestground/oni-runtime:v2
	docker push iptestground/oni-runtime:v3-debug

pull-images:
	docker pull iptestground/oni-buildbase:v5
	docker pull iptestground/oni-runtime:v2
	docker pull iptestground/oni-runtime:v3-debug
