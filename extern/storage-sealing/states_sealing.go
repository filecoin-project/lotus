...
func (m *Sealing) handlePreCommitting(ctx statemachine.Context, sector SectorInfo) error {
	...
	mcid, err := m.api.SendMsg(ctx.Context(), waddr, m.maddr, builtin2.MethodsMiner.PreCommitSector, deposit, m.feeCfg.MaxPreCommitGasFee, enc.Bytes())
	if err != nil {
...
func (m *Sealing) handleSubmitCommit(ctx statemachine.Context, sector SectorInfo) error {
	...
	mcid, err := m.api.SendMsg(ctx.Context(), waddr, m.maddr, builtin2.MethodsMiner.ProveCommitSector, collateral, m.feeCfg.MaxCommitGasFee, enc.Bytes())
	if err != nil {
