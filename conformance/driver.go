...
func (d *Driver) ExecuteTipset(bs blockstore.XBlockstore, ds ds.Batching, preroot cid.Cid, parentEpoch abi.ChainEpoch, tipset *schema.Tipset, execEpoch abi.ChainEpoch) (*ExecuteTipsetResult, error) {
	var (
...
func (d *Driver) ExecuteMessage(bs blockstore.XBlockstore, params ExecuteMessageParams) (*vm.ApplyRet, cid.Cid, error) {
	if !d.vmFlush {
