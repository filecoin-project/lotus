...
func dumpThreeWayStateDiff(r Reporter, vector *schema.TestVector, bs blockstore.XBlockstore, actual cid.Cid) {
...
func writeStateToTempCAR(bs blockstore.XBlockstore, roots ...cid.Cid) (string, error) {
...
func LoadVectorCAR(vectorCAR schema.Base64EncodedBytes) (blockstore.XBlockstore, error) {
